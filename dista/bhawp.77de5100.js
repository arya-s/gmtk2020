...
},{"./entity":"entity.ts","./level":"level.ts","./utils":"utils.ts"}],"tile.ts":[function(require,module,exports) {
"use strict";
...
},{"./solid":"solid.ts"}],"aseprite.ts":[function(require,module,exports) {
"use strict";
...
},{"./aseprite":"aseprite.ts","./sprites/waterfall_32.json":"sprites/waterfall_32.json"}],"level.ts":[function(require,module,exports) {
"use strict";
...
},{"./solid":"solid.ts","./tile":"tile.ts","./vec2":"vec2.ts","./movingwall":"movingwall.ts","./spike":"spike.ts","./utils":"utils.ts","./waterfall_bottom":"waterfall_bottom.ts"}],"actor.ts":[function(require,module,exports) {
"use strict";
...
},{"./aseprite":"aseprite.ts","./sprites/player_v2.json":"sprites/player_v2.json"}],"player.ts":[function(require,module,exports) {
"use strict";
...
},{"./actor":"actor.ts","./level":"level.ts","./vec2":"vec2.ts","./keys":"keys.ts","./utils":"utils.ts","./playersprite":"playersprite.ts","./spike":"spike.ts"}],"mouse.ts":[function(require,module,exports) {
"use strict";
...
},{"./utils":"utils.ts","./sprite":"sprite.ts","./vec2":"vec2.ts","./level":"level.ts"}],"maps/large_level.json":[function(require,module,exports) {
module.exports = {
  "ogmoVersion": "3.3.0",
  "width": 1280,
  "height": 180,
...
init();
requestAnimationFrame(tick);
},{"./level":"level.ts","./player":"player.ts","./utils":"utils.ts","./mouse":"mouse.ts","./maps/large_level.json":"maps/large_level.json","stats.js":"node_modules/stats.js/build/stats.min.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/bhawp.77de5100.js.map